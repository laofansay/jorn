...
pm2 start npm --name jorn -- run dev -p 3100

pm2 start npm --name "jorn" -- run start -- -p 3000

pm2 start npm --name "nextjs-app" -- start -- -p 3000

pm2 start npx --name "jorn" -- next -p 3100
...
pm2 delete 3
pm2 list
pm2 start npm --name "jorn" -- start -- --port 3100
